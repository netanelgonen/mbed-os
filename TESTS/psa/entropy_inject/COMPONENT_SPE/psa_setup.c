...
extern const uint32_t crypto_external_sids[4];
...
spm_partition_t g_partitions[3] = {
    ...
    {
        .partition_id = CRYPTO_ID,
        .thread_id = 0,
        .flags_rot_srv = CRYPTO_WAIT_ANY_SID_MSK,
        .flags_interrupts = 0,
        .rot_services = NULL,
        .rot_services_count = CRYPTO_ROT_SRV_COUNT,
        .extern_sids = crypto_external_sids,
        .extern_sids_count = CRYPTO_EXT_ROT_SRV_COUNT,
        .irq_mapper = NULL,
    },
    {
        .partition_id = ITS_ID,
