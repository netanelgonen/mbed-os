...
#ifndef PSA_CRYPTO_PARTITION_H
#define PSA_CRYPTO_PARTITION_H

#define CRYPTO_ID 35

#define CRYPTO_ROT_SRV_COUNT (11UL)
#define CRYPTO_EXT_ROT_SRV_COUNT (4UL)

/* CRYPTO event flags */
#define CRYPTO_RESERVED1_POS (1UL)
#define CRYPTO_RESERVED1_MSK (1UL << CRYPTO_RESERVED1_POS)

#define CRYPTO_RESERVED2_POS (2UL)
#define CRYPTO_RESERVED2_MSK (1UL << CRYPTO_RESERVED2_POS)
...
#define CRYPTO_WAIT_ANY_SID_MSK (\
    PSA_CRYPTO_INIT | \
    PSA_MAC | \
    PSA_HASH | \
    PSA_ASYMMETRIC | \
